                ...
                <div className={` rounded-lg p-8 w-96 bg-white`}>
                    ...
                    <div className='flex justify-between mb-4'>
                        <a href={`https://www.facebook.com/sharer/sharer.php?u=${link}&title=react-chat`} target='_blank'>
                            <FaFacebook className='text-blue-600 hover:text-blue-900 cursor-pointer' size={30} />
                        </a>
                        <a href={`https://twitter.com/intent/tweet?url=${link}&text=react-chat`} target='_blank'>
                            <FaTwitter className='text-blue-400 hover:text-blue-700 cursor-pointer' size={30} />
                        </a>
                        < a href={`https://www.linkedin.com/shareArticle?url=${link}&title=react-chat&summary=Join-room`} target='_blank'>
                            <FaLinkedin className='text-blue-600 hover:text-blue-950 cursor-pointer' size={30} />
                        </a>
                        <a href={`https://api.whatsapp.com/send?text=react-chat+${link}`} target='_blank'>
                            <FaWhatsapp className='text-green-500 hover:text-green-950 cursor-pointer' size={30} />
                        </a>
                    ...
                    <div className='mb-4'>
                        <p className='mb-2'>Click to Copy</p>
                        <div className='flex items-center border-2 border-[gray] rounded overflow-hidden'>
                            <input type='text' value={link} className='flex-1 p-2 bg-gray-100' readOnly />
                        </div>
                    </div>
                    <button onClick={copyLink} className='w-full bg-[#e13232] text-white py-2 rounded'>{copy}</button>
                </div>
            </div>
        </>
    );
